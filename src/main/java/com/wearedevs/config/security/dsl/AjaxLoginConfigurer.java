package com.wearedevs.config.security.dsl;
...
public final class AjaxLoginConfigurer<H extends HttpSecurityBuilder<H>> extends AbstractAuthenticationFilterConfigurer<H, AjaxLoginConfigurer<H>, AjaxLoginProcessingFilter> {
    ...
    public void configure(H http) throws Exception {
        ...
        SessionAuthenticationStrategy sas = http.getSharedObject(SessionAuthenticationStrategy.class);
        if (sas != null) {
            getAuthenticationFilter().setSessionAuthenticationStrategy(sas);
        }
